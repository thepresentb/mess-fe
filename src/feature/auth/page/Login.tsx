  ...
  return (
    <>
      ...
      <div className="flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center">
        <div
          className="flex flex-col overflow-hidden bg-white rounded-md shadow-[0_0_50px_#ccc] max md:flex-row md:flex-1 lg:max-w-screen-md"
        >
          <div
          ...
          >
            ...
            <p className="flex flex-col items-center justify-center mt-10 text-center">
              <span>{t("auth.haventAcccount")}</span>
              <a href="/register" className="underline">{t("auth.start")}</a>
            </p>
          ...
          <div className="p-5 bg-white md:flex-1">
            <h3 className="my-4 text-2xl font-semibold text-gray-700 text-center">{t("auth.login")}</h3>
            <form action="#" onSubmit={handleSubmit} className="flex flex-col space-y-5">
              <InputCommon key='username' name='username' lable={t("auth.username")} onChange={inputChange} />
              <InputCommon key='password' name='password' type="password" lable={t("auth.password")} onChange={inputChange} subLable={<a href="#" className="text-sm text-blue-600 hover:underline focus:text-blue-800">{t("auth.forgotPassword")}</a>} />
              <div className="flex items-center space-x-2">
                ...
                />
                <label htmlFor="remember" className="text-sm font-semibold text-gray-500">{t("auth.rememberMe")}</label>
              </div>
              <div>
                <button
                  type="submit"
              ...
              <div className="flex flex-col space-y-5">
                <span className="flex items-center justify-center space-x-2">
                  ...
                  <span className="font-normal text-gray-500">{t("auth.loginWith")}</span>
                  <span className="h-px bg-gray-400 w-14"></span>
                </span>
                <div className="flex flex-col space-y-4">
                  ...
                  <a
                    href="#"
                    className="flex items-center justify-center px-4 py-2 space-x-2 transition-colors duration-300 border border-blue-500 rounded-md group hover:bg-green-500 focus:outline-none"
                  >
                    <span>
